...
_skills = [["aimingAccuracy", _aimingAccuracyLevel], ["aimingShake", _aimingShakeLevel], ["aimingSpeed", _aimingSpeedLevel], ["spotDistance", _spotDistanceLevel], ["spotTime", _spotTimeLevel], ["courage", _courageLevel], ["commanding",_commanding], ["general", _general], ["endurance",_enduranceLevel], ["reloadSpeed", _reloadspeedLevel]];
_skills;